<!-- <div id="aside-main" data-aos="fade-left">
  <div class="asidebar">
    ...
    <div class="wrap-widget">
        ...
        <div class="container pb-3">
            ...
            <div class="row mt-2">
                    ...
                    <div class="col-8"><b><a class="text-color-mustard" href="<?php echo base_url('article/view/').$hype['id_artikel']?>">"<?php echo $hype['judul']; ?>"</a></p></b></div>
        </div>
            <?php endforeach;?>
        </div>
    </div>
    <div class="wrap-widget">
        <div class="wrap-widget-header">
            <hr>
                <h5 class="text-center text-black"><img class="images-grid" src="<?php echo base_url('./assets/images/grid.png')?>" alt="" width="20px">&nbsp;<strong> Artikel <?php echo $jenisArtikel3 ?></strong></img></h4>
            <hr>
        </div>
        <div class="container pb-3">
        <?php 
