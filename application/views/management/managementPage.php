  ...
  <div class="bg-mustard" data-aos="fade">
    <div class="container">
      <div class="row">
        ...
        <a href="https://www.youtube.com/channel/UCVw2hX3tXPK44WR7a-qXAVg/featured" target="_blank" class="col-2 text-center py-4 social-icon d-block"><span class="icon-pinterest text-white"></span></a>
      </div>
    </div>
  </div>
